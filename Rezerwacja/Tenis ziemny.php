		...
		<div id="container"> 
		  ...
		  <div id="logo">
			...
			<div id="leftmenu">
				...
				<li><a href="Tenis ziemny.php" class="current1">Tenis ziemny</a></li>
				</ul>
			</div>
				<div id="content">
            	    ...
            	    <a href="Formularz.php">
            	    										<img src="img/kort_tenisowy.jpg" alt="Tenis ziemny" title="Tenis ziemny" border="0" width="160" height="120" />
																		</a> <br/>
            	    <br/><b>Kort 1 , Ślężna 22, Cena 50 zł/1h</b><br/>
							</div>
						</div>
							<div style="float:left">
                             <div class="menager">
            	    ...
            	    <br/><b>Kort 2 , Ślężna 22, Cena: 50 zł/1h</b><br/>
							</div>
						</div>
							<div style="float:left">
                             <div class="menager">
            	    ...
            	    <br/><b>Kort 3 , Ślężna 22, Cena: 50 zł/1h</b><br/>
							</div>
						</div>
