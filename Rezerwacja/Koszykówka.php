		...
		<div id="container"> 
		  ...
		  <div id="logo">
			...
			<div id="leftmenu">
				...
				<li><a href="Koszykówka.php" class="current1" >Koszykówka</a></li>
				...
				<div id="content">
            	    ...
            	    <a href="Formularz.php">
            	    										<img src="img/boisko_kosz.jpg" alt="Koszykówka" title="Koszykówka" border="0" width="160" height="120" />
																		</a> <br/>
            	    <br/><b>Koszykówka, Sportowa 2, Cena 100zł/1H</b><br/>
							</div>
						</div>
						<div style="float:left">
                             <div class="menager">
            	    <a href="Formularz.php">
            	    										<img src="img/boisko_kosz2.jpg" alt="Koszykówka" title="Koszykówka" border="0" width="160" height="120" />
																		</a> <br/>
            	    <br/><b>Koszykówka, Ślężna 21, Cena 100zł/1H</b><br/>
							</div>
